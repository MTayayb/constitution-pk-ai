...
from vector_store.builder import IndexBuilder
from retriever.retriever import ConstitutionRetriever
from data_fallback import GET_FULL_CONSTITUTION_DATASET

def load_articles():
    """Loads articles from JSON, fallback dataset, or PDF parser."""
    data_path = os.path.join(os.path.dirname(__file__), "data/parsed_articles.json")
